        ...
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                    ...
                    <?php if(!empty($existe)):?>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php echo BASE_URL;?>posto/gerenciar-posto">Gerenciar Posto</a>
                    <?php endif;?>
                </div>
            </li>
        </ul>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm action_content">
                ...
                <div class="action_btn d-flex justify-content-center">
                    <a href="<?php echo BASE_URL;?>posto/doacoes-para-receber" class="btn btn-primary">Doações para receber</a>
                </div>
            </div>
            <div class="col-sm action_content">
                <div class="action_image">
                ...
                <div class="action_btn d-flex justify-content-center">
                    <a href="<?php echo BASE_URL;?>posto/doacoes-em-andamento" class="btn btn-primary">Doações em Andamento</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm action_content">
                ...
                <div class="action_btn d-flex justify-content-center">
                    <a href="<?php echo BASE_URL;?>posto/doacoes-concluidas" class="btn btn-primary">Doações concluídas</a>
                </div>
            </div>
            <div class="col-sm">
